...
(function ($) {
  ...
  $ ('#link-button').on ('click', function () {
    $ ('#link-button').html (
      '<iframe width="1044" height="587" src="https://www.youtube.com/embed/OJeW56dnej0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
    );
  });
  ...
  $ (
    'nav a[href^="#"]:not([href="#"]), .back_to_top, .explore'
